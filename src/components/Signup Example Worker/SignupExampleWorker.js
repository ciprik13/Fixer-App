...
import "./SignupExampleWorker.css";
    ...
    return (
        <div className="signup-client-container">
            <div className="signup-client-header">
                <div className="signup-client-text">Sign Up as Worker</div>
            ...
            <form onSubmit={handleSubmit} className="signup-client-inputs">
                ...
                <div className="login-text">Already have an account? <Link to="/loginexampleclient">Log In</Link></div>
            </form>
        </div>
    );
};
